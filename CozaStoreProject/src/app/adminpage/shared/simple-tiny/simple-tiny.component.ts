...
export class SimpleTinyComponent implements AfterViewInit,OnDestroy  {
  ...
  ngAfterViewInit() {
    ...
    tinymce.init({
      ...
      plugins: "autosave autolink code codesample emoticons fullscreen hr image imagetools media preview table wordcount",
      toolbar: "imageupload forecolor colorpicker cut copy paste fontselect styleselect bold italic bold link preview code image",
      setup: editor => {
        this.editor = editor;
        editor.on('keyup', () => {
