...
export class UserComponent implements OnInit {
  ...
  loadUserDetail(id: any) {
      ...
      .subscribe((response: any)=>{
        ...
        var date = moment(response.BirthDay).format('L');

        this.entity.BirthDay = moment(date).format('MM/DD/YYYY')
      })
  }
  ...
  deleteItemConfirm(id: any) {
    this._dataService.delete('/api/appUser/delete', id).subscribe((response: Response) => {
